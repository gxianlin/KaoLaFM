    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = BaseApplication.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = BaseApplication.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
